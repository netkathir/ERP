...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('subcontractor_evaluations', function (Blueprint $table) {
            ...
            // Subcontractor information (supplier with supplier_type = 'Sub Contractor')
            ...
            $table->text('subcontractor_remarks')->nullable();
            ...
            $table->unsignedInteger('subcontractor_technology_rating');
            $table->text('subcontractor_technology_remarks')->nullable();
