                    ...
                    <tr style="background: #f8f9fa; border-bottom: 2px solid #dee2e6;">
                        ...
                        <th style="padding: 12px; text-align: left; color: #333; font-weight: 600; white-space:nowrap;">
                            <span style="display:inline-flex; align-items:center; gap:5px;">
                                SubCategory
                                @php
                                    $newSortOrder = ($currentSortBy == 'sub_category' && $currentSortOrder == 'desc') ? 'asc' : 'desc';
                                @endphp
                                <a href="#" class="sort-link" data-sort-by="sub_category" data-sort-order="{{ $newSortOrder }}" style="text-decoration:none; color:#333; display:inline-flex; align-items:center;">
                                    @if($currentSortBy == 'sub_category')
                                        @if($currentSortOrder == 'desc')
                                            <i class="fas fa-sort-down"></i>
                                        @else
                                            <i class="fas fa-sort-up"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    sortLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            fetch('{{ route("raw-materials.index") }}?' + urlParams.toString(), {
                method: 'GET',
            ...
            .then(html => {
                ...
                window.history.pushState({}, '', '{{ route("raw-materials.index") }}?' + urlParams.toString());
