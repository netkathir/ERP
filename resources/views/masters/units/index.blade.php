                    ...
                    <tr style="background: #f8f9fa; border-bottom: 2px solid #dee2e6;">
                        ...
                        <th style="padding: 12px; text-align: left; color: #333; font-weight: 600; white-space:nowrap;">
                            <span style="display:inline-flex; align-items:center; gap:5px;">
                                Symbol
                                @php
                                    $newSortOrder = ($currentSortBy == 'symbol' && $currentSortOrder == 'desc') ? 'asc' : 'desc';
                                @endphp
                                <a href="#" class="sort-link" data-sort-by="symbol" data-sort-order="{{ $newSortOrder }}" style="text-decoration:none; color:#333; display:inline-flex; align-items:center;">
                                    @if($currentSortBy == 'symbol')
                                        @if($currentSortOrder == 'desc')
                                            <i class="fas fa-sort-down"></i>
                                        @else
                                            <i class="fas fa-sort-up"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    sortLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            fetch('{{ route("units.index") }}?' + urlParams.toString(), {
                method: 'GET',
            ...
            .then(html => {
                ...
                window.history.pushState({}, '', '{{ route("units.index") }}?' + urlParams.toString());
